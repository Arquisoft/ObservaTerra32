...
public class BeanSettings implements Serializable {
	...
	public void init() {
		...
		// Buscamos el alumno en la sesi贸n. Esto es un patr贸n factor铆a
		// claramente.
